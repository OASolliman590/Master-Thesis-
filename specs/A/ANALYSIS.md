...
Current source audits give ceilings of49 category-labelled baseline Riaz patients and88 labelled Rose patient codes, not eligible N or proof of power. The SD groups contain16 and4 patient codes respectively. Rose timing, response-adjudication and repeated-assay selection remain open; Riaz source/QC exclusions and full-matrix suitability remain open. See DATA.md and the6 September source reports. Before readiness, calculate anticipated interval widths using actual admitted category counts and a documented range of plausible score separations; simulated data are precision scenarios, never evidence of biology. Record achieved precision after analysis without promising statistical significance. The material precision target remains a scientific decision; no invented minimum N is accepted.
